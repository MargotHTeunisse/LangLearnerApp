...
public class WebAPITest {
    ...
    @Test
    public void testAnswerIsIncorrectIfDoesNotMatchBack() {
        String back = "kissa";
        when(userDeck.getDrawnCard())
                .thenReturn(new Card("", back));

        boolean answerIsCorrect = api.submitAnswer("something else").answerIsCorrect();
    ...
    @Test
    public void testDeckIsNotDepletedIfDrawReturnsFalse() {
        when(userDeck.draw())
                .thenReturn(true);
        when(userDeck.getDrawnCard())
                .thenReturn(new Card("", ""));
        ...
        Assertions.assertFalse(deckIsDepleted);
    }
